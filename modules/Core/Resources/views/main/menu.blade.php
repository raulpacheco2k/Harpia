        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item dropdown">
                @auth()
                    ...
                    <span
                        class="avatar avatar-sm">{{ Auth::user()->name_initials }}</span>
                        <div class="d-none d-xl-block ps-2">
                            <div>{{ Auth::user()->full_name }}</div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        @include('core::components.logout')
                    </div>
                @endauth
                @guest()
                ...
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/lifebuoy -->
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                       ...
                       stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><circle
                          cx="12" cy="12" r="4"></circle><circle cx="12" cy="12" r="9"></circle><line x1="15"
                                                                                                      y1="15"
                                                                                                      x2="18.35"
                                                                                                      y2="18.35"></line><line
                          x1="9" y1="15" x2="5.65" y2="18.35"></line><line x1="5.65" y1="5.65" x2="9" y2="9"></line><line
                          x1="18.35" y1="5.65" x2="15" y2="9"></line></svg>
                </span>
                                <span class="nav-link-title">
                  Ajuda
                </span>
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" target="_blank"
                                   href="https://github.com/raulpacheco2k/Harpia/issues">Reporte um bug</a>
                            </div>
                        </li>
                    </ul>
                </div>
